...
import app.org.multiwii.swingui.ds.MwDataModel;
import app.org.multiwii.swingui.ds.MwDataSource;
...
public final class MSP {
	...
	final static class ByteBuffer extends ByteArrayInputStream implements
		...
		public void run() {
			 ...
			 * InputStream read(); read(); read(); read();
			 */
	...
	/**
	 * Function decode is designed to be called only from a serialEvent thread,
	 * not from any other thread. It decodes the most recent input byte in an
	 * MSP reply. It manages state information so it knows where it is in a
	 * reply packet on each successive call.
	 *
	 * @param input
	 *            is a an int with the upper 24 bits set to zero and thusly this
	 *            contains only 8 bits of information.
	 */
