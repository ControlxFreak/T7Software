...
/*
import app.org.multiwii.swingui.ds.MwSensorClass;
import app.org.multiwii.swingui.ds.MwSensorClassMotor;
import app.org.multiwii.swingui.ds.MwSensorClassServo;
*/
...
public class MwUAVPanel extends MwInstrumentJPanel {
	...
	private int uavType = MSP.UAV_QUADX;
	...
	void drawBarValue(Graphics2D g2d) {
		...
		switch (uavType) {
		case MSP.UAV_BI:
			drawBar(g2d, 0, motor, null, UAV_BI_MOTOR_X, UAV_BI_MOTOR_Y, YAXIS);
		...
		case MSP.UAV_TRI:
			...
			break;
		case MSP.UAV_QUADP:
			drawBar(g2d, 0, motor, null, UAV_QUADP_MOTOR_X, UAV_QUADP_MOTOR_Y,
					YAXIS);

			break;
		case MSP.UAV_QUADX:
			drawBar(g2d, 0, motor, null, UAV_QUADX_MOTOR_X, UAV_QUADX_MOTOR_Y,
					YAXIS);
